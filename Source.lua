...
local redzlib = {
    ...
    ColorSequenceKeypoint.new(0.50, Color3.fromRGB(150, 0, 0)),
...
["Color Text"] = Color3.fromRGB(255, 230, 200),
...
local SetProps, SetChildren, InsertTheme, Create do
	...
	pcall(Save, "Someone - Main/Library Settings/Settings.json")
end
...
function redzlib:SetTheme(NewTheme)
	...
	SaveJson("Someone - Main/Library Settings/Settings.json", redzlib.Save)
...
function redzlib:MakeWindow(Configs)
	...
	local WMiniText = Configs[2] or Configs.SubTitle or Configs or "by : redz9999"
	
	Settings.ScriptFile = Configs[3] or Configs.SaveFolder or Configs or false
	...
	function Window:AddTab(paste, Configs)
		...
		local TName = Configs[1] or Configs.Title or Configs or "Tab!"
		local TIcon = Configs[2] or Configs.Icon or Configs or ""
    ...
    local SectionImage = nil

    if typeof(Configs) == "table" then
        SectionName = Configs[1] or Configs.Name or Configs.Title or Configs.Section
        SectionImage = Configs[2] or Configs.Image or Configs.Icon
    elseif typeof(Configs) == "string" then
        if Configs:lower():find("rbxassetid://") or Configs:lower():find("rbx://") then
            SectionImage = Configs
            SectionName = "" -- só imagem
        else
            SectionName = Configs
        end
    end
    ...
    local SectionLabel = InsertTheme(Create("TextLabel", SectionFrame, {
        Font = Enum.Font.GothamBold,
        Text = (type(SectionName) == "string") and SectionName or "",
        TextColor3 = Theme["Color Text"],
        Size = UDim2.new(1, -LabelOffset - 5, 1, 0),
    ...
    function Section:Set(New)
        if New then
            if typeof(New) == "table" then
                SectionLabel.Text = New[1] or ""
                if SectionFrame:FindFirstChild("Icon") and New[2] then
                    SectionFrame.Icon.Image = New[2]
                elseif New[2] and tostring(New[2]):find("rbx") then
                    local SectionIcon = Create("ImageLabel", SectionFrame, {
                        Image = New[2],
                        Size = UDim2.new(0, 18, 0, 18),
                        Position = UDim2.new(0, 5, 0.5, -9),
                    ...
                    LabelOffset = 28
                    SectionLabel.Position = UDim2.new(0, LabelOffset, 0, 0)
                    SectionLabel.Size = UDim2.new(1, -LabelOffset - 5, 1, 0)
                end
            elseif typeof(New) == "string" then
                if New:lower():find("rbxassetid://") or New:lower():find("rbx://") then
                    if SectionFrame:FindFirstChild("Icon") then
                        SectionFrame.Icon.Image = New
                    else
                        local SectionIcon = Create("ImageLabel", SectionFrame, {
                            Image = New,
                            Size = UDim2.new(0, 18, 0, 18),
    ...
    return Section
		...
		function Tab:AddParagraph(Configs)
			...
			local PDesc = Configs[2] or Configs.Text or Configs or ""
		...
		function Tab:AddButton(Configs)
			local BName = Configs[1] or Configs.Name or Configs.Title or Configs or "Button!"
			local BDescription = Configs.Desc or Configs.Description or Configs or ""
		...
		function Tab:AddToggle(Configs)
			local TName = Configs[1] or Configs.Name or Configs.Title or Configs or "Toggle"
			local TDesc = Configs.Desc or Configs.Description or Configs or ""
			local Callback = Funcs:GetCallback(Configs, 3)
			local Flag = Configs[4] or Configs.Flag or false
			local Default = Configs[2] or Configs.Default or Configs or false
		...
		function Tab:AddDropdown(Configs)
			local DName = Configs[1] or Configs.Name or Configs.Title or Configs or "Dropdown"
			local DDesc = Configs.Desc or Configs.Description or Configs or ""
			local DOptions = Configs[2] or Configs.Options or Configs or {}
			local OpDefault = Configs[3] or Configs.Default or Configs or {}
			local Flag = Configs[5] or Configs.Flag or false
			local DMultiSelect = Configs.MultiSelect or Configs or false
